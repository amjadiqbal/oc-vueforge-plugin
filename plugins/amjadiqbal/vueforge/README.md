...
Composer package: `amjadiqbal/vueforge`. Until this plugin is published on
Packagist and the October CMS Marketplace (see `docs/MARKETPLACE_CHECKLIST.md`
for the outstanding steps), install it manually:

1. Copy or clone this repository's `plugins/amjadiqbal/vueforge` directory
   into your October CMS application's `plugins/amjadiqbal/vueforge`.
